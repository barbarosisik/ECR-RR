...
if __name__ == '__main__':
    with open('data/emo_data/entity2id.json', 'r', encoding='utf-8') as f:
        entity2id = json.load(f)
    item_set = set()

    process('data/emo_data/valid_data_dbpedia_emo.jsonl', 
            'data/emo_data/valid_data_processed.jsonl', 
            item_set)
    process('data/emo_data/test_data_dbpedia_emo.jsonl', 
            'data/emo_data/test_data_processed.jsonl', 
            item_set)
    process('data/emo_data/train_data_dbpedia_emo.jsonl', 
            'data/emo_data/train_data_processed.jsonl', 
            item_set)
