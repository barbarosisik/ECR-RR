...
def load_rl_model_and_tokenizer(base_model_path, rl_model_path):
...
def main():
    ...
    parser.add_argument("--rl_model", type=str, required=True, help="RL model path")
    ...
    parser.add_argument("--output_file", type=str, default="results/rl_ecr_evaluation_proper.json", help="Output file")
